...
export const Palette: React.FC<IconProps> = (props) => (
  ...
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="13.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="10.5" r=".5" fill="currentColor"/><circle cx="8.5" cy="7.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="12.5" r=".5" fill="currentColor"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.667 0-.422-.163-.82-.43-1.125-.295-.33-1.152-1.24-1.152-1.24s1.591-1.22 1.591-2.625c0-1.406-1.119-2.5-2.5-2.5s-2.5 1.094-2.5 2.5c0 .313.055.615.15.906.33.996 1.35.996 1.35.996s.922.922.33 2.05c-.609 1.157-2.157 1.157-2.157 1.157s-1.547 0-2.157-1.157c-.58-1.128.33-2.05.33-2.05s1.02-.01 1.35-.996a2.403 2.403 0 0 0 .15-.906c0-1.406-1.119-2.5-2.5-2.5s-2.5 1.094-2.5 2.5c0 1.406 1.591 2.625 1.591 2.625s-.857.91-1.152 1.24c-.267.305-.43.703-.43 1.125C2.352 21.254 3.074 22 4 22c5.5 0 10-4.5 10-10S17.5 2 12 2z"/>
  </svg>
);
...
export const Visa: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#142688" stroke="none">
        <path d="M8.45 6.27l-3.32 11.46h2.41l.99-3.43h4.91l.73 3.43h2.41L13.27 6.27H8.45zm-.53 6.59l1.5-5.2h.16l1.5 5.2h-3.16zm9.32-6.59h-2.1l-1.87 11.46h2.41l1.56-11.46zM5.1 6.27L2.17 14.6l-.28 1.18c-.33 1.12-.79 1.68-1.78 1.68H0V18h.11c1.33 0 2.05-.72 2.47-2.85L4.4 7.63l.23-1.36h2.62L5.1 6.27z"/>
    </svg>
);
...
export const Mastercard: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <circle cx="16" cy="12" r="7" fill="#F79E1B" fillOpacity="0.85"/>
    </svg>
);
...
export const Car: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M14 16.5 17.5 13H22v-4H12l-3 6H3.5A2.5 2.5 0 0 1 1 12.5V10c0-1.1.9-2 2-2h3l2-4h4l2 4h3v2h-1.34" />
...
export const Tshirt: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const Dog: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M10 5.2L9.4 4.1C8.6 2.7 7.2 2 5.5 2H4c-1.1 0-2 .9-2 2v2.5c0 .4.2.8.4 1.1L3 10c.1.2.1.5 0 .7s-.3.3-.5.3H2c-.3 0-.5.2-.5.5v2c0 .3.2.5.5.5H3c.2 0 .4.1.5.3s.1.5 0 .7l-.6.9c-.3.4-.4.8-.4 1.2V19c0 1.1.9 2 2 2h1.5c1.7 0 3.1-.7 3.9-2.1L10 18.8" />
    <path d="M15 6l-1 2" />
    <path d="M14 10l2 2" />
    <path d="M14 14l1 2" />
    <path d="M15 18l-1-2" />
...
export const Baby: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M19 6.3a9 9 0 0 1 1.8 3.9 2 2 0 0 1 0 3.6 9 9 0 0 1-17.6 0 2 2 0 0 1 0-3.6A9 9 0 0 1 12 3c2 0 3.5 1.1 3.5 2.5s-1.5 2.5-3.5 2.5c-2 0-3.5-1.1-3.5-2.5S10 3 12 3a9 9 0 0 1 7 3.3Z"/>
  </svg>
);
...
export const Sparkles: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="m12 3-1.9 1.9-1.1-3-1.9 1.9-3-1.1 1.9 1.9-3 1.1 1.9 3-1.1 1.9 3 1.1-1.9 1.9 1.1 3 1.9-1.9 3 1.1-1.9-3-1.1-3-1.9 1.9-1.1 3 1.9-1.9 3-1.1Z"/>
    <path d="M5 3v4"/>
    <path d="M19 17v4"/>
    <path d="M3 5h4"/>
    <path d="M17 19h4"/>
